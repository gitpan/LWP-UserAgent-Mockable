...
my $pre_and_post = $ua->get( "http://google.com"  );
...
my $post = $ua->get( "http://google.com" );
...
my $unfaked = $ua->get( "http://google.com" );
...
eval {
    $no_response_returned = $ua->get( "http://google.com" );
};
...
eval {
    $no_response_returned_post = $ua->get( "http://google.com" );
};
